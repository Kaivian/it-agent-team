...
- Technical Specification Authoring: Produces TECHNICAL_SPEC.md detailing architecture overviews, verbatim contract enclaves, file ownership tables, and acceptance criteria.
...
- File Authoring Tools: Write and update TECHNICAL_SPEC.md, user requirement matrices, and task descriptions.
...
3. Contract Drafting: Author TECHNICAL_SPEC.md including architectural diagrams, verbatim contract enclaves, and file manifests.
...
5. Critic Hand-off: Submit the completed technical specification to the Critic Agent for adversarial review and architectural sign-off.
