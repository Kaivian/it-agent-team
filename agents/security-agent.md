...
- Security Verdict Authority: Issues SECURITY_PASS or SECURITY_FAIL based on findings.
...
- File Viewing: Read flagged source chunks and configuration files to evaluate context and false positive risks.
...
5. Verdict Delivery: If clean, issue SECURITY_PASS; if vulnerabilities or secrets are detected, emit SECURITY_FAIL with an itemized remediation guide.
