...
5. Verdict Delivery: If all checks succeed, issue QA_PASS; if any failure occurs, compile a structured defect report to .gemini/QA_BUG_REPORT.md and issue QA_FAIL to initiate the debugger remediation loop.
